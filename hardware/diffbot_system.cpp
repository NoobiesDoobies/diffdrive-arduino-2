...
#include "diffbot_control/diffbot_system.hpp"
...
hardware_interface::return_type diffbot_control::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_motor_.connected() || !comms_imu_.connected())
  {
...
PLUGINLIB_EXPORT_CLASS(
  diffbot_control::DiffBotSystemHardware, hardware_interface::SystemInterface)
